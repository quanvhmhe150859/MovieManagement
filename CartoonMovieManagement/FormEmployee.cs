...
namespace CartoonMovieManagement
{
	public partial class FormEmployee : Form
	{
		...
		private FormEmployeeHistory? formEmployeeHistory;
		...
		{
			if (formEmployeeHistory == null || formEmployeeHistory.IsDisposed)
			{
				formEmployeeHistory = new FormEmployeeHistory();
				formEmployeeHistory.Show();
			}
			else
			{
				// If the form is already open, bring it to the front
				formEmployeeHistory.BringToFront();
			}
		}
	}
}
